...
module PersonRelationshipConcern
  ...
  included do |base|
    ...
    base::MaleRelationships = MaleRelationships
    base::FemaleRelationships = FemaleRelationships
    base::Relationships = Relationships
    base::Relationships_UI = Relationships_UI
    base::InverseMap = InverseMap
    base::Kinds = Kinds
    ...
    validates :kind,
              ...
              allow_blank: false,
              allow_nil:   false,
              inclusion: {in: base::Kinds, message: "%{value} is not a valid person relationship"}
