...
describe PersonRelationship, dbclean: :around_each do
  it { should validate_presence_of(:relative_id).with_message(/Choose a relative/)}
  it { should validate_presence_of :kind }

  let(:kind) {"spouse"}
  let(:person) {FactoryBot.create(:core_person, gender: "male", dob: "10/10/1974", ssn: "123456789" )}
